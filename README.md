# Home Assistant Companion — design artifacts

Importable sticker-sheet for **`Jetpack Compose Material + Home Assistant theme`**, rendered from the committed
`@Preview` catalog in [`yschimke/home-assistant-android`](https://github.com/yschimke/home-assistant-android). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/home-assistant-android/blob/design-artifacts/home-assistant-android/index.html)**
...
**[▶ Open the PNG↔SVG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/home-assistant-android/blob/design-artifacts/home-assistant-android/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/home-assistant-android/)**

The same rendered components, served live by `compose-preview serve --catalogs home-assistant-android` —
...
| Components with a11y greenlines | **10** |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/home-assistant-android/blob/design-artifacts/home-assistant-android/index.html) |
| `compare.html` | PNG↔SVG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/home-assistant-android/blob/design-artifacts/home-assistant-android/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/home-assistant-android/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/yschimke/home-assistant-android/actions/workflows/design-artifacts.yml)
